...
function useVisualElement(Component2, visualState, props, createVisualElement2) {
  ...
  const wantsHandoff = (0, import_react6.useRef)(Boolean(props[optimizedAppearDataAttribute]));
...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "10.16.14", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.16.14 may not work as expected.`);
      }
